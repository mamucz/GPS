...
namespace RTP.GPS.Nmea
{
    public class GnsDevice : object, IDisposable
    {
        ...
        public delegate void ReceiveRawNmeaMessageEventHandler(string RawNmeaMessage);
        ...
        {
            OnReceiveRawNmeaMessage(message.ToString());
        ...
        public void OnReceiveRawNmeaMessage(string RawNmeaMessage)
        {
