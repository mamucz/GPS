...
namespace RTP.GPS.Nmea
{
	...
	public abstract class NmeaMessage
	{
		...
		public static NmeaMessage Parse(string message)
		{
            ...
            string msgSubType = MessageType.Substring(2,3);
            string originalType = MessageType;
            string key = messageTypes.Keys.FirstOrDefault(mkey => mkey.Contains(msgSubType));
            if (key!=null)
			{
				msg = (NmeaMessage)messageTypes[key].Invoke(new object[] { });
			}
			else
			{
